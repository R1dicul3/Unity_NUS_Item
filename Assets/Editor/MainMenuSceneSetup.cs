...
namespace MainMenu.Editor
{
    ...
    public class MainMenuSceneSetup
    {
        ...
        static void CreateAllScenes()
        {
            ...
            EditorSceneManager.SaveScene(mainScene, "Assets/Scenes/Core/MainMenu.unity");
            ...
            EditorSceneManager.SaveScene(loadScene, "Assets/Scenes/Core/LoadGame.unity");
        ...
        static void CreateMainMenuScene()
        {
            ...
            EditorSceneManager.SaveScene(scene, "Assets/Scenes/Core/MainMenu.unity");
            AddSceneToBuildSettings("Assets/Scenes/Core/MainMenu.unity");
            AssetDatabase.Refresh();
        }
        ...
        static void CreateLoadGameScene()
        {
            ...
            EditorSceneManager.SaveScene(scene, "Assets/Scenes/Core/LoadGame.unity");
            AddSceneToBuildSettings("Assets/Scenes/Core/LoadGame.unity");
            AssetDatabase.Refresh();
        }
